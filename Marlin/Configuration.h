...
#define STRING_CONFIG_H_AUTHOR "(UnCNeon)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro FreeABL"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -16, -5 } // BUNU OLC
 ...
 * just remove some S menu items to recover space.
 */
//#define NO_LCD_MENUS
